...
type
  ...
  TOrbitalElements = record
    N: Double; // dolgota voskhodyashchego uzla
    i: Double; // naklon k ekliptike (ploskosti orbity Zemli)
    w: Double; // argument perigeliya
    a: Double; // bol'shaya poluos', ili sredneye rasstoyaniye ot Solntsa
    e: Double; // ekstsentrisitet (0 = krug, 0-1 = ellips, 1 = parabola)
    M: Double; // srednyaya anomaliya (0 v perigelii; ravnomerno uvelichivayetsya so vremenem)
  end;

  // Ispol'zuetsya dlya vychisleniya vysheukazannogo .. v zavisimosti ot tekushchego vremeni
